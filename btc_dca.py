...
# NOTE: For tutorial, first show this block without filtering for relevant columns
...
# TODO: append entries to existing spreadsheet
...
# Now we enter formulas into the spreadsheet
